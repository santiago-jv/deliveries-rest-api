...
exports.refreshToken = exports.registerAdmin = exports.loginAdmin = void 0;
...
function refreshToken(request, response) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const admin = yield Admin_1.default.findById(payload.id);
            const newToken = jsonwebtoken_1.default.sign({ id: admin._id }, process.env.JWT_SECRET);
